...
output_path = 'C:/Users/mohamedm/Networkintegration/sherlock/data/fmri/templates/annotation_similarities.csv'
...
for subject_number in range(1, 18):
    ...
    if os.path.exists(recall_path):
        ...
        for _, row in merged_df.iterrows():
            ...
            # Check if recall_annotation is NaN, skip if true
